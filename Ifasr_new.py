...
if __name__ == '__main__':
    folder_path = 'audio_full' # 音频文件夹路径
    wav_files = collect_and_convert_audios(folder_path) # 转换音频文件为.wav格式

    with open('Output-cn.txt', 'a+', encoding='utf-8') as f, ThreadPoolExecutor(max_workers=50) as executor:
        futures = {executor.submit(RequestApi(appid="",
                                              secret_key="",
